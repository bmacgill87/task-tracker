...
export class InputView extends SKContainer implements Subscriber {
    ...
    private headerLabel: SKLabel = new SKLabel({ text: "Add New Assignment", align: "centre" });
    ...
    private button: SKButton = new SKButton({ text: "Add" });
    ...
    constructor() {
        ...
        // button
        this.button.font = "12pt sans-serif";
        ...
        this.grid5.addChild(this.button);
    ...
    public setEvents(c: Controller) {
        this.button.addEventListener("action", () => {
            c.newAssignment(this.courseField.text, this.titleField.text, this.dateField.text, this.descriptionField.text);
        })
    }
